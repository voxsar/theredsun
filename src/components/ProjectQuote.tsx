      ...
      <div className="pt-20 min-h-screen bg-gradient-to-br from-light-green/20 to-olivine/20 flex items-center justify-center">
        <div className="max-w-2xl mx-auto px-4 text-center">
          <div className="bg-white rounded-3xl p-12 shadow-2xl">
            ...
            <h1 className="text-4xl font-bold text-dim-gray mb-6">Quote Request Submitted!</h1>
            <p className="text-xl text-dim-gray/70 mb-8">
            ...
            <div className="space-y-4 mb-8">
              <p className="text-dim-gray/70">
                <strong>What's Next:</strong>
              </p>
              <div className="space-y-2 text-left bg-gray-50 rounded-xl p-6">
                <p className="text-sm text-dim-gray/70">1. Our team reviews your requirements</p>
                <p className="text-sm text-dim-gray/70">2. We'll schedule a consultation call</p>
                <p className="text-sm text-dim-gray/70">3. You'll receive a detailed proposal</p>
                <p className="text-sm text-dim-gray/70">4. We discuss and refine the project scope</p>
              </div>
            </div>
            <button
              onClick={() => {
    ...
    <div className="pt-20 min-h-screen bg-gradient-to-br from-peach/10 via-white to-red-ncs/5">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-dim-gray mb-6">Get Your Project Quote</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-8 shadow-lg">
          {step === 1 && (
            <div className="space-y-8">
              <h2 className="text-2xl font-bold text-dim-gray mb-6">Project Details</h2>

              {/* Project Type */}
              <div>
                <label className="block text-sm font-medium text-dim-gray mb-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {projectTypes.map((type) => (
                    ...
                    >
                      <h3 className="font-semibold text-dim-gray">{type.name}</h3>
                      <p className="text-sm text-dim-gray/70 mt-1">{type.description}</p>
                    </button>
                  ))}
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {budgetRanges.map((budget) => (
                    ...
                    >
                      ...
                      <span className="font-medium text-dim-gray">{budget.label}</span>
                    </button>
                  ))}
                </div>
              </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {timelineOptions.map((timeline) => (
                    ...
                    >
                      ...
                      <span className="font-medium text-dim-gray">{timeline.label}</span>
                    </button>
                  ))}
                </div>
              </div>
          ...
          {step === 2 && (
            <div className="space-y-8">
              <h2 className="text-2xl font-bold text-dim-gray mb-6">Features & Requirements</h2>
              ...
              {/* Description */}
              <div>
                <label className="block text-sm font-medium text-dim-gray mb-2">
                  Project Description *
                </label>
                <textarea
                  name="description"
          ...
          {step === 3 && (
            <div className="space-y-8">
              <h2 className="text-2xl font-bold text-dim-gray mb-6">Contact Information</h2>
