  ...
  return (
    <div className="pt-20">
      ...
      <section className="py-24 bg-gradient-to-br from-light-green/20 via-white to-olivine/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <h1 className="text-5xl lg:text-6xl font-bold text-dim-gray mb-6">Sustainability</h1>
            <p className="text-xl text-dim-gray/70 max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="space-y-6">
                <h2 className="text-3xl font-bold text-dim-gray">Our Environmental Commitment</h2>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-dim-gray mb-6">Our Green Initiatives</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {initiatives.map((initiative, index) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-dim-gray mb-4">{initiative.title}</h3>
                <p className="text-dim-gray/70 leading-relaxed mb-4">{initiative.description}</p>
                <div className="bg-white rounded-lg p-3 border-l-4 border-olivine">
                  <p className="text-sm font-medium text-olivine">Impact: {initiative.impact}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-dim-gray mb-6">Sustainability Roadmap</h2>
            <p className="text-xl text-dim-gray/70 max-w-3xl mx-auto">
            ...
            {goals.map((goal, index) => (
              <div key={index} className="flex items-center space-x-8 bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                ...
                <div className="flex-grow">
                  <h3 className="text-2xl font-bold text-dim-gray mb-2">{goal.target}</h3>
                  <p className="text-dim-gray/70 leading-relaxed">{goal.description}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-white/80">Carbon Footprint Reduction</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold mb-2">1,200</div>
              <div className="text-white/80">Trees Planted This Year</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold mb-2">85%</div>
              <div className="text-white/80">Renewable Energy Usage</div>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold mb-2">0</div>
              <div className="text-white/80">Waste to Landfills</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-gradient-to-br from-light-green/20 to-olivine/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-dim-gray mb-6">Join Our Sustainability Journey</h2>
          <p className="text-xl text-dim-gray/70 max-w-3xl mx-auto mb-10">
